...
expect_identical(results[[1]]$groups[[1]]$questions[[1]]$result$ok, TRUE)
...
expect_identical(results[[1]]$groups[[1]]$questions[[1]]$result$ok, FALSE)
expect_identical(results[[1]]$groups[[1]]$questions[[1]]$body, "Q_1")
...
expect_identical(results[[1]]$groups[[1]]$questions[[2]]$result$ok, TRUE)
...
expect_identical(results[[1]]$groups[[1]]$questions[[2]]$result$ok, FALSE)
expect_identical(results[[1]]$groups[[1]]$questions[[2]]$body, "Q_2")
...
## getQuestionAsked <- function(quiz) {
##     qs <- c()
##     for(group in quiz$groups) {
##         if(group$type ==)
##             if(group$type == "random") {
##                 qs <- c(qs, group$questions[sample(1:length(group$questions), group$num)])
##             } else {
##                 qs <- c(qs, group$questions)
##             }
##     }
